...
public class MavenJavadocSourcesPluginChoreTest {

	@RegisterExtension
	final FileSystemExtension extension = new FileSystemExtension();

	private void doit() {
		new MavenJavadocSourcesPluginChore().doit(extension.choreContext());
	}
	...
	public void test() throws Exception {
		...
		FilesSilent.writeString(
				pom,
				ClassPathFiles
						.readString("maven-javadoc-sources-plugin/input.xml")
		);
		...
		String expected = ClassPathFiles
				.readString("maven-javadoc-sources-plugin/expected.xml");
